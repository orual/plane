...
def validate_property_value(value, property_definition):
    """
    Validate a property value against its property definition type.

    Raises serializers.ValidationError if the value is invalid for the property type.
    """
...
class IssuePropertyValueSerializer(BaseSerializer):
    ...
    def validate(self, data):
        ...
        validate_property_value(value, property_definition)
        return data
